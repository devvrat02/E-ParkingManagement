...
String Park="";          ////////////////****Global variable Declaration starts from here
...
char server[] =".000webhostapp.com"; //"elinkgoogle.com"; 
// WiFi Parameters
const char* ssid = "";
const char* password = "malviya_4";
...
//  client.println("POST /hardware/hard.php HTTP/1.1");
    ...
    client.println("Host: ....000webhostapp.com"); //web.google.com");
