            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="list-group">
                        ...
                        <a href="admin.php"  class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>Admins</a>
                    </div>
                ...
                <span class="caret"></span>
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                            <li><a href="add_park.php">Add Parking</a></li>
                            <li><a href="del_park.php">Delete Parking</a></li>
                        </ul>
                    </div>
                </div>
                        </div>
